...
- to demonstrate understanding of html structure.

## WEBSITE FEATURES

- Home page that introduces woolworths
- Product page the display woolworths products
- navigation menu for easy navigation
- enquiry form for user questions
- simple a clean layout
...
- include javascript for functionality / interactivity
